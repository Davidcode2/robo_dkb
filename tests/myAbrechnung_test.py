...
class TestAbrechnung(unittest.TestCase):
    ...
    def test_getDateRange_2023_01(self):
        ...
        self.assertEqual(abrechnung.getDateRange(1, 2023), {'date_from': '01.01.2023', 'date_to': '31.01.2023'})

    def test_getDateRange_2024_12(self):
        abrechnung = myAbrechnung.Abrechnung()
        self.assertEqual(abrechnung.getDateRange(12, 2024), {'date_from': '01.12.2024', 'date_to': '31.12.2024'})
    ...
    def test_getDateRange_2023_13(self):
        ...
        self.assertEqual(str(context.exception), "Month must be an integer between 1 and 12.")
